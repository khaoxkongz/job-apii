...
import { IHandlerCompany } from '../interfaces/handlers/interface-handler-company';
import { IUseCasesCompany } from '../../domian/interfaces/usecases/usecases-company';

class HandlerCompany extends BaseHandler<IUseCasesCompany> implements IHandlerCompany {
  constructor(useCases: IUseCasesCompany) {
    super(useCases);
  }

  public createCompany: IHandlerCompany['createCompany'] = async (req, res) => {
  ...
  public getCompanyById: IHandlerCompany['getCompanyById'] = async (req, res) => {
  ...
  public getAllCompanies: IHandlerCompany['getAllCompanies'] = async (_req, res) => {
  ...
  public updateCompanyById: IHandlerCompany['updateCompanyById'] = async (req, res) => {
    const { id: companyId } = req.params;
    const { name, description, contactEmail, contactPhone } = req.body;
  ...
  public deleteCompanyById: IHandlerCompany['deleteCompanyById'] = async (req, res) => {
    const { id: companyId } = req.params;
